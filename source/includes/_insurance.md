...
<!-- MARKDOWN-AUTO-DOCS:START (CODE:src=../../tmp-python-sdk/examples/chain_client/insurance/query/1_Vouchers.py) -->
<!-- The below code snippet is automatically added from ../../tmp-python-sdk/examples/chain_client/insurance/query/1_Vouchers.py -->
```py
import asyncio
...
<!-- MARKDOWN-AUTO-DOCS:START (CODE:src=../../tmp-go-sdk/examples/chain/insurance/query/1_Vouchers/example.go) -->
<!-- The below code snippet is automatically added from ../../tmp-go-sdk/examples/chain/insurance/query/1_Vouchers/example.go -->
```go
package main
...
<!-- MARKDOWN-AUTO-DOCS:START (JSON_TO_HTML_TABLE:src=./source/json_tables/injective/insurance/QueryVouchersRequest.json) --><table class="JSON-TO-HTML-TABLE"><thead><tr><th class="parameter-th">Parameter</th><th class="type-th">Type</th><th class="description-th">Description</th><th class="required-th">Required</th></tr></thead><tbody ><tr ><td class="parameter-td td_text">denom</td><td class="type-td td_text">string</td><td class="description-td td_text">denom filter; empty string returns all vouchers</td><td class="required-td td_text">Yes</td></tr></tbody></table><!-- MARKDOWN-AUTO-DOCS:END -->
...
<!-- MARKDOWN-AUTO-DOCS:START (JSON_TO_HTML_TABLE:src=./source/json_tables/injective/insurance/QueryVouchersResponse.json) -->
<table class="JSON-TO-HTML-TABLE"><thead><tr><th class="parameter-th">Parameter</th><th class="type-th">Type</th><th class="description-th">Description</th></tr></thead><tbody ><tr ><td class="parameter-td td_text">vouchers</td><td class="type-td td_text">AddressVoucher array</td><td class="description-td td_text">List of outstanding vouchers matching the request filter.</td></tr></tbody></table>
<!-- MARKDOWN-AUTO-DOCS:END -->
...
<!-- MARKDOWN-AUTO-DOCS:START (JSON_TO_HTML_TABLE:src=./source/json_tables/injective/common/vouchers/AddressVoucher.json) -->
<table class="JSON-TO-HTML-TABLE"><thead><tr><th class="parameter-th">Parameter</th><th class="type-th">Type</th><th class="description-th">Description</th></tr></thead><tbody ><tr ><td class="parameter-td td_text">address</td><td class="type-td td_text">string</td><td class="description-td td_text">The bech32 address of the voucher holder.</td></tr>
<tr ><td class="parameter-td td_text">voucher</td><td class="type-td td_text">Coin</td><td class="description-td td_text">The outstanding voucher coin.</td></tr></tbody></table>
<!-- MARKDOWN-AUTO-DOCS:END -->
...
<!-- MARKDOWN-AUTO-DOCS:START (CODE:src=../../tmp-python-sdk/examples/chain_client/insurance/query/2_Voucher.py) -->
<!-- The below code snippet is automatically added from ../../tmp-python-sdk/examples/chain_client/insurance/query/2_Voucher.py -->
```py
import asyncio
...
<!-- MARKDOWN-AUTO-DOCS:START (CODE:src=../../tmp-go-sdk/examples/chain/insurance/query/2_Voucher/example.go) -->
<!-- The below code snippet is automatically added from ../../tmp-go-sdk/examples/chain/insurance/query/2_Voucher/example.go -->
```go
package main
...
<!-- MARKDOWN-AUTO-DOCS:START (JSON_TO_HTML_TABLE:src=./source/json_tables/injective/insurance/QueryVoucherRequest.json) -->
<table class="JSON-TO-HTML-TABLE"><thead><tr><th class="parameter-th">Parameter</th><th class="type-th">Type</th><th class="description-th">Description</th><th class="required-th">Required</th></tr></thead><tbody ><tr ><td class="parameter-td td_text">denom</td><td class="type-td td_text">string</td><td class="description-td td_text">Required. The token denom to look up.</td><td class="required-td td_text">Yes</td></tr>
<tr ><td class="parameter-td td_text">address</td><td class="type-td td_text">string</td><td class="description-td td_text">Required. The bech32 address of the voucher holder.</td><td class="required-td td_text">Yes</td></tr></tbody></table>
<!-- MARKDOWN-AUTO-DOCS:END -->
...
<!-- MARKDOWN-AUTO-DOCS:START (JSON_TO_HTML_TABLE:src=./source/json_tables/injective/insurance/QueryVoucherResponse.json) -->
<table class="JSON-TO-HTML-TABLE"><thead><tr><th class="parameter-th">Parameter</th><th class="type-th">Type</th><th class="description-th">Description</th></tr></thead><tbody ><tr ><td class="parameter-td td_text">voucher</td><td class="type-td td_text">Coin</td><td class="description-td td_text">The outstanding voucher coin for the requested denom and address.</td></tr></tbody></table>
<!-- MARKDOWN-AUTO-DOCS:END -->
...
<tr ><td class="parameter-td td_text">oracle_type</td><td class="type-td td_text">OracleType</td><td class="description-td td_text">Oracle type of the binary options or derivative market</td><td class="required-td td_text">Yes</td></tr>
...
<tr ><td class="parameter-td td_text">initial_deposit</td><td class="type-td td_text">Coin</td><td class="description-td td_text">Initial deposit of the insurance fund</td><td class="required-td td_text">Yes</td></tr></tbody></table>
<!-- MARKDOWN-AUTO-DOCS:END -->
...
<tr ><td class="parameter-td td_text">deposit</td><td class="type-td td_text">Coin</td><td class="description-td td_text">Amount of quote_denom to underwrite the insurance fund.</td><td class="required-td td_text">Yes</td></tr></tbody></table>
<!-- MARKDOWN-AUTO-DOCS:END -->
...
<tr ><td class="parameter-td td_text">market_id</td><td class="type-td td_text">string</td><td class="description-td td_text">MarketID of the insurance fund.</td><td class="required-td td_text">Yes</td></tr>
<tr ><td class="parameter-td td_text">amount</td><td class="type-td td_text">Coin</td><td class="description-td td_text">Insurance fund share token amount to be redeemed.</td><td class="required-td td_text">Yes</td></tr></tbody></table>
<!-- MARKDOWN-AUTO-DOCS:END -->
...
<!-- MARKDOWN-AUTO-DOCS:START (CODE:src=../../tmp-python-sdk/examples/chain_client/insurance/4_MsgClaimVoucher.py) -->
<!-- The below code snippet is automatically added from ../../tmp-python-sdk/examples/chain_client/insurance/4_MsgClaimVoucher.py -->
```py
import asyncio
import json
import os
...
<!-- MARKDOWN-AUTO-DOCS:START (CODE:src=../../tmp-go-sdk/examples/chain/insurance/1_MsgClaimVoucher/example.go) -->
<!-- The below code snippet is automatically added from ../../tmp-go-sdk/examples/chain/insurance/1_MsgClaimVoucher/example.go -->
```go
package main
...
<!-- MARKDOWN-AUTO-DOCS:START (JSON_TO_HTML_TABLE:src=./source/json_tables/injective/insurance/MsgClaimVoucher.json) -->
